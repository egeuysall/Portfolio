...
export default function Home() {
  return (
    ...
    >
      <header>
        <h1 className={`${lato.className} text-4xl font-bold text-center mb-2`}>Ege Uysal Portfolio</h1>
        <p className={`${poppins.className} text-sm text-center text-gray-500 mb-4`}
        >
